...
?>
   			...
   			<div class="well"> 
             <form class="form-horizontal" role="form" method="POST" action="../database/schedule.php">
			  ...
			  <input type="hidden" name="rsvp" value="<?php echo $cname; ?>">
			  <input type="submit" class="btn btn-success pull-right" value="<?php echo "RSVP->".$cname; ?>"> <ul class="list-inline"><li></li></ul>
              </form>
