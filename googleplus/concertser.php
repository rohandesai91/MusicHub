...
<div class="container" id="main">
  ...
  <div class="well"> 
             <form class="form-horizontal" role="form">
              <h4>Concert Search<h4>
			  
			    <ul class="list-group">
                <div class="form-group" style="padding:14px;">
                <input type="date" name="stdate" class="form-control" placeholder="Enter Date">
				<br>
				<input type="date" name="enddate" class="form-control" placeholder="Enter Date">
              </div>
				</ul>
			  <input type='submit' class="btn btn-info pull-right" value='Enter'> <ul class="list-inline"><li></li></ul>
              </form>
